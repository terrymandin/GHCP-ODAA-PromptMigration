...
- Migration Questionnaire from `Artifacts/Phase10-Migration/ZDM/<DATABASE_NAME>/Step3/`
- Issue Resolution Log from `Artifacts/Phase10-Migration/ZDM/<DATABASE_NAME>/Step4/`
- **Verification Results** from `Artifacts/Phase10-Migration/ZDM/<DATABASE_NAME>/Step4/Verification-Results-<DATABASE_NAME>.md` (generated by `verify_fixes.sh` — commit and push to repo before Step 5; the script writes the file directly into the repo clone and prints the git commands to run)
...
#file:Artifacts/Phase10-Migration/ZDM/<DATABASE_NAME>/Step4/Issue-Resolution-Log-<DATABASE_NAME>.md

## Verification Results (from Step4 verify_fixes.sh)
#file:Artifacts/Phase10-Migration/ZDM/<DATABASE_NAME>/Step4/Verification-Results-<DATABASE_NAME>.md
...
## Output Directory
Save all generated artifacts to: Artifacts/Phase10-Migration/ZDM/<DATABASE_NAME>/Step5/
```
...
2. **Prerequisites Checklist**
   ...
   **Step 4 Blockers Checklist** — populate using `Verification-Results-<DATABASE_NAME>.md` if provided:
