...
- **Verification Results** from `Artifacts/Phase10-Migration/ZDM/<DATABASE_NAME>/Step2/Verification-Results-<DATABASE_NAME>.md` (generated by `verify_fixes.sh` — commit to repo before Step 3)
