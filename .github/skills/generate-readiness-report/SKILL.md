...
1. Summarize the source, target, migration method, and downtime requirement.
...
6. Derive the overall decision deterministically:
     ...
     Job creation or a generated command is not an eval pass.
